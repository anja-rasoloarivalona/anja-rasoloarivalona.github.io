$(document).ready(function(){ 
      ...
      .to($projectsCircle2, 1, {autoAlpha: 1, scale: 1},'+=.5')
      .to($projectsCircle3, 1, {autoAlpha: 1, scale: 1},'-=1')
      .to($projectsCircle4, 1, {autoAlpha: 1, scale: 1},'+=.5')
      

      TweenMax.from(".projects__upperline--fromHome", 2, {opacity: "0", ease:Power0.easeNone}).delay(.2);
      TweenMax.from(".projects__upperline--1", .4, {opacity: "0", ease:Power0.easeNone}).delay(1.4);
      TweenMax.from(".projects__upperline--2", 1, {opacity: "0", ease:Power0.easeNone}).delay(3);
      TweenMax.from(".projects__upperline--3", 1, {opacity: "0", ease:Power0.easeNone}).delay(3);
      TweenMax.from(".projects__upperline--4", 1, {opacity: "0", ease:Power0.easeNone}).delay(4.5);
      TweenMax.from(".projects__upperline--5", 1, {opacity: "0", ease:Power0.easeNone}).delay(4.5);
      
    TweenMax.from(".projects__upperline--fromHome__in", .8, {width: "0", ease:Power0.easeNone}).delay(.6); 
    TweenMax.from(".projects__upperline--1__in", .6, {width: "0", ease:Power0.easeNone}).delay(2); 
    TweenMax.from(".projects__upperline--2__in", .6, {width: "0px", ease:Power0.easeNone}).delay(3.5);
    TweenMax.from(".projects__upperline--3__in", .6, {width: "0px", ease:Power0.easeNone}).delay(3.5);
    TweenMax.from(".projects__upperline--4__in", .6, {width: "0px", ease:Power0.easeNone}).delay(5);
    TweenMax.from(".projects__upperline--5__in", .6, {width: "0px", ease:Power0.easeNone}).delay(5); 
